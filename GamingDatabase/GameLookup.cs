    ...
    public partial class GameLookup : Form
    {
        ...
        private void uxFindGame_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                adapter = new SqlDataAdapter("Select * From Gaming.Game Where Name LIKE '%" + game + "%'", connection);
                dt = new DataTable();
                adapter.Fill(dt);
            ...
            {
                MessageBox.Show("Error with information entered, please try again.");
            }
        }
        ...
        private void uxFindGameReleaseYear_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error with information received, please try again.");
                connection.Close();
            }
        }
